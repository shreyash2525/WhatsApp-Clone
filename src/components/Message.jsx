    ...
    <div className={`flex justify-center items-center rounded-md w-fit my-1 ${
        ...
        (
            <div className="flex justify-between items-end max-w-[410px] p-2" style={{ wordBreak: "break-word" }}>
                {isLink ? (
                    <a href={msg} target='_blank' rel="noreferrer" className='text-[#53beec] hover:text-[#53beec] focus:text-[#53beec] active:text-[#53beec] text-sm underline hover:underline mr-2'>
                        {msg}    
                    </a>
                    ) : (
